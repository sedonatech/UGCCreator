...
const AppStack = () => (
    ...
    >
        <Screen name={APP_TABS} options={{ headerShown: false }} component={AppTabs} />
        <Screen name={SUBSCRIPTION} component={SubscriptionScreen} options={TRANSPARENT_HEADER_NO_LOGO} />
        <Screen name={CREATORS_PROFILES_STACK} component={CreatorsProfilesStack} options={TRANSPARENT_HEADER} />
        <Screen name={EVENTS_SCREEN} component={EventsScreen} options={TRANSPARENT_HEADER} />
        <Screen name={FAVORITE_EVENTS_SCREEN} component={FavoriteEventsScreen} options={TRANSPARENT_HEADER} />
        <Screen name={EVENT_DETAILS_SCREEN} component={EventDetailsScreen} options={TRANSPARENT_HEADER} />
