...
import {
    APP_TABS, CREATORS_PROFILES_STACK, EVENT_DETAILS_SCREEN, EVENTS_SCREEN, FAVORITE_EVENTS_SCREEN, PITCH_PAL_SCREEN, SUBSCRIPTION, WEBVIEW,
} from '../ScreenNames';
import AppTabs from './AppTabs';
import {
    SWITCH, TRANSPARENT_HEADER, TRANSPARENT_HEADER_NO_LOGO,
...
const AppStack = () => (
    ...
    >
        ...
        />
        <Screen
            name={PITCH_PAL_SCREEN}
            options={TRANSPARENT_HEADER}
            component={PitchPalScreen}
        />
    </Navigator>
);
