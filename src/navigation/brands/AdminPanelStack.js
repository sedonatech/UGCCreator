...
const AdminPanelStack = () => (
    ...
    >
        <Screen name={ADMIN_PANEL} options={TRANSPARENT_HEADER} component={AdminPanelScreen} />
        <Screen name={ADD_PROJECT} options={TRANSPARENT_HEADER} component={AddProjectScreen} />
        <Screen name={BRAND_PROJECTS} options={TRANSPARENT_HEADER} component={BrandProjectsScreen} />
        <Screen name={BRAND_PROJECT_DETAILS} options={TRANSPARENT_HEADER} component={BrandProjectDetailsScreen} />
        <Screen name={UPDATE_BRAND_PROFILE} options={TRANSPARENT_HEADER} component={UpdateBrandProfileScreen} />
        <Screen name={CREATOR_PROJECT_STATUS} options={TRANSPARENT_HEADER} component={CreatorProjectStatusScreen} />
        ...
        <Screen name={CREATORS_PROFILES} options={TRANSPARENT_HEADER} component={CreatorProfilesScreen} />
