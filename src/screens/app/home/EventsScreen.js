...
import { EVENT_DETAILS_SCREEN, FAVORITE_EVENTS_SCREEN } from '../../../navigation/ScreenNames';
    ...
    useLayoutEffect(() => {
        navigation.setOptions({
            headerRight: () => (
                ...
                >
                    <TemplateIcon name="heart" size={hp(20)} family="Ionicons" color={ERROR_RED} />
                </TemplateBox>
            ),
    ...
    const ListHeaderComponent = (
        <TemplateBox>
            ...
            <TemplateBox row alignItems="center" mh={WRAPPER_MARGIN} mt={WRAPPER_MARGIN}>
                <TemplateTextInput
                    placeholder={t('home.events.searchPlaceholder')}
    ...
    const ListEmptyComponent = (
        <TemplateBox flex center mt={hp(HEADER_MARGIN)}>
            <TemplateText size={hp(14)} semiBold>
                {search?.length ? t('home.events.emptyStates.withSearch') : t('home.events.emptyStates.withoutSearch')}
            </TemplateText>
        </TemplateBox>
    );
