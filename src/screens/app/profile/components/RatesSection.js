...
import {
    BLACK, BLACK_20, GREY, WHITE,
} from '../../../../theme/Colors';

const RatesSection = ({ rates }) => (
    <TemplateBox mh={WRAPPER_MARGIN} mt={WRAPPER_MARGIN * 2}>
        <TemplateText bold color={BLACK} size={18}>Current Rates</TemplateText>
        ...
        >
            <TemplateBox selfCenter>
                <TemplateText bold size={18} color={BLACK}>Monthly Package</TemplateText>
            </TemplateBox>
        ...
        >
            <TemplateBox selfCenter>
                <TemplateText bold size={18} color={BLACK}>Video Starting Rates</TemplateText>
            </TemplateBox>
            <TemplateBox height={WRAPPER_MARGIN} />
            <TemplateBox selfCenter>
                {
        ...
        >
            <TemplateBox selfCenter>
                <TemplateText bold size={18} color={BLACK}>Photo Starting Rates</TemplateText>
            </TemplateBox>
            <TemplateBox height={WRAPPER_MARGIN} />
            <TemplateBox selfCenter>
                {
        ...
        >
            <TemplateBox selfCenter>
                <TemplateText bold size={18} color={BLACK}>Revisions</TemplateText>
            </TemplateBox>
            <TemplateBox height={WRAPPER_MARGIN} />
            <TemplateBox selfCenter>
                {
        ...
        >
            <TemplateBox selfCenter>
                <TemplateText bold size={18} color={BLACK}>Usage Rights</TemplateText>
            </TemplateBox>
            <TemplateBox height={WRAPPER_MARGIN} />
            <TemplateBox selfCenter>
                {
        ...
        >
            <TemplateBox selfCenter>
                <TemplateText bold size={18} color={BLACK}>Exclusive Rights</TemplateText>
            </TemplateBox>
            <TemplateBox height={WRAPPER_MARGIN} />
            <TemplateBox selfCenter>
                {
