...
import {
    ...
    METAL,
    OFF_WHITE,
    ONBOARDING_BG_BORDER,
    ONBOARDING_BG_LIGHT,
    ONBOARDING_SURFACE_BLUE,
    ONBOARDING_SURFACE_GREEN,
    ONBOARDING_SURFACE_GRAY,
    ONBOARDING_SURFACE_ORANGE,
    ONBOARDING_SURFACE_PINK,
    PINK_50,
    PINK_600,
    SLATE_500,
    SLATE_900,
...
const onboardingEducationMeta = {
    deals: {
        ...
        imageSurface: ONBOARDING_SURFACE_BLUE,
    },
    matches: {
        ...
        imageSurface: ONBOARDING_SURFACE_GREEN,
    },
    aiTools: {
        ...
        imageSurface: ONBOARDING_SURFACE_PINK,
    },
    courses: {
        ...
        imageSurface: ONBOARDING_SURFACE_ORANGE,
    },
    portfolio: {
        ...
        imageSurface: ONBOARDING_SURFACE_GRAY,
    },
};
...
const styles = StyleSheet.create({
    container: {
        flex: 1,
        backgroundColor: ONBOARDING_BG_LIGHT,
        alignItems: 'center',
        overflow: 'hidden',
    },
    topOrb: {
    ...
    progressTrack: {
        ...
        height: 8,
        borderRadius: 999,
        backgroundColor: ONBOARDING_BG_BORDER,
        overflow: 'hidden',
    },
    progressFill: {
        height: '100%',
