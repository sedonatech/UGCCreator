...
export const CATEGORY_CARD_HEIGHT = IS_SHORT_DEVICE ? SCREEN_HEIGHT / 8 : SCREEN_HEIGHT / 8;

export const CATEGORY_CARD_WIDTH = IS_SMALL_DEVICE ? SCREEN_WIDTH / 4 : SCREEN_WIDTH / 4;

export const OFFER_CARD_HEIGHT = IS_SMALL_DEVICE ? SCREEN_HEIGHT / 3.5 : SCREEN_HEIGHT / 3.5;

export const OFFER_CARD_WIDTH = IS_SMALL_DEVICE ? SCREEN_WIDTH / 2.2 : SCREEN_WIDTH / 2.2;

// eslint-disable-next-line no-nested-ternary
const HEADER_MARGIN_OFFSET = IS_ANDROID ? 2.2 : IS_IOS_16 ? 5 : 2.6;

export const HEADER_MARGIN = 70;
